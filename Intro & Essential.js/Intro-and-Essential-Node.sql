...
create table album(
    ...
    constraint fk_track_singer_singer_id foreign key(singer_id) references singer(singer_id)
);
...
create table playlist(
    ...
    constraint fk_playlist_user_user_id foreign key(user_id) references user(user_id)
);
--Create table--
create table track(
    ...
    constraint fk_track_singer_singer_id foreign key(singer_id) references singer(singer_id),
    constraint fk_track_album_album_id foreign key(album_id) references album(album_id)
);
